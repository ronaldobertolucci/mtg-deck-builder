...
class CardRuleOverrideServiceTest {
    ...
    private CardDetailsResponse card(String type, String text) {
        return new CardDetailsResponse(UUID.randomUUID(), "Example", type, text, List.of(), io.github.ronaldobertolucci.mtgdeckbuilder.config.CardTestFixtures.legalities(), java.util.List.of());
    }
}
